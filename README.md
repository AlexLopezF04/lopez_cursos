...
erDiagram
    ...
    USUARIO ||--o{ MATRICULA   : "se inscribe"
    USUARIO ||--o{ RESENA      : "escribe"
    CATEGORIA ||--o{ CURSO     : "clasifica"
    CURSO ||--o{ LECCION       : "contiene"
    CURSO ||--o{ MATRICULA     : "tiene"
    CURSO ||--o{ RESENA        : "recibe"
    MATRICULA ||--o{ PROGRESO  : "registra"
    LECCION ||--o{ PROGRESO    : "es evaluada en"
```

> El diagrama se renderiza automáticamente en GitHub. Si lo ves en texto plano, pégalo en [mermaid.live](https://mermaid.live) para visualizarlo.
